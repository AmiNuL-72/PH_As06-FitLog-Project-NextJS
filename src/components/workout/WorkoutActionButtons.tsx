  ...
  return (
    <div className="flex flex-wrap items-center gap-4 pt-2">
      <button
        ...
        className={`font-black text-xs sm:text-sm px-6 py-3.5 rounded-lg transition-all flex items-center gap-2.5 shadow-lg transform hover:scale-[1.02] active:scale-[0.98] cursor-pointer ${
          inPlan
            ? 'bg-[#18260f] text-[#a3e635] border border-[#a3e635]/60'
            : 'bg-[#a3e635] hover:bg-[#b8ff00] text-black'
        }`}
      >
